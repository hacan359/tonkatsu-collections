...
// index.json is auto-generated by .github/workflows/build-index.yml and lives
// at the repo root — the same public artifact the Tonkatsu Box app reads
// via CollectionBrowserService. The site is just another consumer.
// Tried in order: repo-relative (works for local dev when serving the repo
// root and visiting /docs/) -> raw GitHub content (production on GH Pages).
const INDEX_URLS = ['../index.json', REPO_BASE + '/index.json'];
